...
from agile1d.core.inversion import prepare_for_agile_inversion, get_default_inversion_settings, \
    get_control_var_bounds
from agile1d.core.data_logging import initialise_DataLogger
from agile1d.core.cost_function import get_indices_for_unknown_parameters, get_known_parameters, \
...
def test_dir():
    tmp_test_dir = os.path.join(cfg.PATHS['test_dir'], 'agile')
    mkdir(tmp_test_dir)
    yield tmp_test_dir
