...
measurement_mask_Giluwe_cross[16, 3:36] = 1
...
measurement_mask_Giluwe_upper_tongue = np.zeros(shape_Giluwe)
for i in range(4):
    measurement_mask_Giluwe_upper_tongue[7 + i, 16 + i] = 1
    measurement_mask_Giluwe_upper_tongue[7 + i, 17 + i] = 1
