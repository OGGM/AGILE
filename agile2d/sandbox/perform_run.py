...
from agile2d.core.data_manipulation import add_noise_to_first_guess
...
from agile2d.core.data_manipulation import take_true_bed_as_first_guess
...
from agile2d.core.first_guess import apply_bed_measurements_to_first_guess
...
def perform_run(case, basedir, inversion_settings,
    ...
    # path_to_file = '/home/philipp/COBBI/agile/sandbox/Giluwe/bed_measurements.py'
