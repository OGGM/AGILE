...
class TestCase(object):
    ...
    def get_mb_model(self):
        """
        Creates a new ClippedLinearMassBalance based on mb settings of this
        object (ela_h, mb_grad, mb_max_alt, mb_min_alt)

        Returns
        -------
        ClippedLinearMassBalance for this case

        """
        mb_model = ClippedLinearMassBalance(self.ela_h, self.mb_grad,
                                            self.mb_max_alt, self.mb_min_alt)
        return mb_model
